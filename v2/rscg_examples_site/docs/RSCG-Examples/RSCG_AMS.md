...
namespace RSCG_AMSDemo { 
    ...
    public class XAboutMySoftware_828469749970839076110119122 :AboutMySoftware {
        ...
        public XAboutMySoftware_828469749970839076110119122(){
            ...
            DateGenerated = DateTime.ParseExact("20231021172434", "yyyyMMddHHmmss", null); 
            ...
            Authors= "";
            Version= "";    
            EnvironmentVars =";User_Path;User_TEMP;User_TMP;User_OneDriveConsumer;User_ChocolateyLastPathUpdate;User_OneDrive;Process_VSSKUEDITION;Process_DOTNET_HOST_PATH;Process_ChocolateyLastPathUpdate;Process_APPDATA;Process_USERNAME;Process_ChocolateyInstall;Process_OS;Process_ZES_ENABLE_SYSMAN;Process_npm_config_cache;Process_XAMARIN_ANDROID_REGKEY;Process_DOTNET_CLI_TELEMETRY_SESSIONID;Process_windir;Process_DriverData;Process_NUGET_PACKAGES;Process_GCExpConfigUsedInSession;Process_MONO_ANDROID_PATH;Process_LOGONSERVER;Process_CommonProgramW6432;Process_PSModulePath;Process_ProgramFiles;Process_ProgramFiles(x86);Process_USERDOMAIN;Process_ProgramW6432;Process_VSAPPIDNAME;Process_ServiceHubLogSessionKey;Process_Path;Process_PROCESSOR_LEVEL;Process_SignInWithHomeTenantOnly;Process_OneDriveConsumer;Process_CommonProgramFiles(x86);Process_COMPUTERNAME;Process_SESSIONNAME;Process_FPS_BROWSER_USER_PROFILE_STRING;Process_VisualStudioEdition;Process_NUMBER_OF_PROCESSORS;Process_PreferredUILang;Process_MSBuildExtensionsPath;Process_LOCALAPPDATA;Process_VSLANG;Process_FPS_BROWSER_APP_PROFILE_STRING;Process_VisualStudioDir;Process_PROCESSOR_REVISION;Process_USERDOMAIN_ROAMINGPROFILE;Process_SystemDrive;Process_VS_Perf_Session_GCHeapCount;Process_VisualStudioVersion;Process_PATHEXT;Process_VSAPPIDDIR;Process_DOTNET_CLI_UI_LANGUAGE;Process_HOMEDRIVE;Process_POWERSHELL_DISTRIBUTION_CHANNEL;Process_ComSpec;Process_OneDrive;Process_ThreadedWaitDialogDpiContext;Process_PROCESSOR_IDENTIFIER;Process_CommonProgramFiles;Process_PUBLIC;Process_TEMP;Process_HOMEPATH;Process_ProgramData;Process_SystemRoot;Process_ALLUSERSPROFILE;Process_TMP;Process_USERPROFILE;Process_MSBuildSDKsPath;Process_MSBUILDUSESERVER;Process_PkgDefApplicationConfigFile;Process_PROCESSOR_ARCHITECTURE;Process_EFC_14888;Process_MSBuildLoadMicrosoftTargetsReadOnly;Machine_ChocolateyInstall;Machine_OS;Machine_PROCESSOR_ARCHITECTURE;Machine_PROCESSOR_REVISION;Machine_ComSpec;Machine_TMP;Machine_NUGET_PACKAGES;Machine_PATHEXT;Machine_USERNAME;Machine_windir;Machine_Path;Machine_PROCESSOR_LEVEL;Machine_PROCESSOR_IDENTIFIER;Machine_PSModulePath;Machine_DriverData;Machine_NUMBER_OF_PROCESSORS;Machine_POWERSHELL_DISTRIBUTION_CHANNEL;Machine_TEMP;Machine_ZES_ENABLE_SYSMAN;Machine_npm_config_cache";
            User = "ignat";
            IsInCI=false;
