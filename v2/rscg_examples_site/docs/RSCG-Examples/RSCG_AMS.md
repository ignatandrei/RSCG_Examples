...
namespace RSCG_AMSDemo { 
    ...
    public class XAboutMySoftware_828469749970839076110119122 :AboutMySoftware {
        ...
        public XAboutMySoftware_828469749970839076110119122(){
            ...
            DateGenerated = DateTime.ParseExact("20240407175046", "yyyyMMddHHmmss", null); 
            ...
            Authors= "";
            Version= "";    
            EnvironmentVars =";User_TMP;User_OneDrive;User_TEMP;User_Path;User_ChocolateyLastPathUpdate;User_OneDriveConsumer;Process_ChocolateyLastPathUpdate;Process_USERNAME;Process_APPDATA;Process_ProgramFiles;Process_DOTNET_LAUNCH_PROFILE;Process_MSBUILDUSESERVER;Process_ComSpec;Process_PROCESSOR_IDENTIFIER;Process_HOMEPATH;Process_PROCESSOR_LEVEL;Process_MSBuildLoadMicrosoftTargetsReadOnly;Process_windir;Process_PUBLIC;Process_SystemDrive;Process_COMPUTERNAME;Process_OneDriveConsumer;Process_CommonProgramFiles(x86);Process_HOMEDRIVE;Process_PROCESSOR_REVISION;Process_NUMBER_OF_PROCESSORS;Process_DOTNET_HOST_PATH;Process_WSLENV;Process_ProgramW6432;Process_VISUALGDB_DIR;Process_USERPROFILE;Process_WT_PROFILE_ID;Process_MSBuildSDKsPath;Process_LOGONSERVER;Process_MSBuildExtensionsPath;Process_OneDrive;Process_PROCESSOR_ARCHITECTURE;Process_DOTNET_WATCH;Process_CommonProgramW6432;Process_CommonProgramFiles;Process_DOTNET_CLI_TELEMETRY_SESSIONID;Process_SESSIONNAME;Process_ALLUSERSPROFILE;Process_SystemRoot;Process_WT_SESSION;Process_OS;Process_TEMP;Process_ChocolateyInstall;Process_DriverData;Process_Path;Process_USERDOMAIN_ROAMINGPROFILE;Process_ProgramData;Process_PATHEXT;Process_JAVA_HOME;Process_TMP;Process_LOCALAPPDATA;Process_PSModulePath;Process_DOTNET_WATCH_ITERATION;Process_USERDOMAIN;Process_ProgramFiles(x86);Machine_OS;Machine_PROCESSOR_LEVEL;Machine_PROCESSOR_ARCHITECTURE;Machine_JAVA_HOME;Machine_VISUALGDB_DIR;Machine_USERNAME;Machine_PATHEXT;Machine_PROCESSOR_IDENTIFIER;Machine_PROCESSOR_REVISION;Machine_windir;Machine_TEMP;Machine_ComSpec;Machine_PSModulePath;Machine_NUMBER_OF_PROCESSORS;Machine_TMP;Machine_ChocolateyInstall;Machine_Path;Machine_DriverData";
            User = "ignat";
            IsInCI=false;
