...
```
  ...
  <TabItem value="C:\test\RSCG_Examples\v2\rscg_examples\RSCG_Static\src\RSCG_StaticDemo\RSCG_StaticDemo\Program.cs" label="Program.cs" >
...
```
  ...
  <TabItem value="C:\test\RSCG_Examples\v2\rscg_examples\RSCG_Static\src\RSCG_StaticDemo\RSCG_StaticDemo\StaticToInterface.cs" label="StaticToInterface.cs" >
