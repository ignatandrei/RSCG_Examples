...
| [`Ling.Blazor.Authentication`](src/Ling.Blazor.Authentication) | [![NuGet](https://img.shields.io/nuget/v/Ling.Blazor.Authentication.svg)](https://www.nuget.org/packages/Ling.Blazor.Authentication/) | A library that provides JWT authentication for Blazor applications. |
