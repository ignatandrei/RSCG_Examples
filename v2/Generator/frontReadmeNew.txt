...
The RSCG_Examples repository is a comprehensive documentation system that automatically processes and showcases {{nr}} Roslyn Source Code Generator (RSCG) examples. The system transforms individual RSCG projects into structured documentation with code examples and cross-referenced content with a searchable website  and code example  exports.
...
{{~ for category in categories ~}}[{{category}}](https://ignatandrei.github.io/RSCG_Examples/v2/docs/rscg-examples#{{category  | string.downcase }})  -  {{~ end ~}}
