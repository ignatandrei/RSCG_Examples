...
,new("Dexie https://github.com/b-straub/DexieNET",tooComplicated)
    ...
    public MultiGeneratorV2(string root)
    {
        ...
        generators = new()
        {
            ...
            {"RSCG_Static",before.PutCategory(Category.EnhancementInterface) },
            ...
            {"Matryoshki" , new(true,new(2023,8,3), Category.EnhancementInterface)},
            {"MemoryPack" , new(true,new(2023,8,4), Category.EnhancementClass)},
            {"DeeDee" , new(true,new(2023,8,5),Category.EnhancementProject)},
            {"ProxyGen", new(true,new(2023,8,6),Category.EnhancementInterface)},
            ...
            {"Biwen.AutoClassGen",new(true,new(2023,11,16),Category.EnhancementInterface) },
            ...
            {"CopyCat",new(true,new(2024,1,9),Category.EnhancementInterface) } ,
